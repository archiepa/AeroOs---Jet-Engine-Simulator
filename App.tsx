...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-slate-950 text-slate-200 overflow-hidden font-sans selection:bg-cyan-500/30">
      ...
      {/* Top Bar / Header */}
      <header className="bg-slate-900 border-b border-slate-800 flex flex-wrap items-center justify-between gap-y-2 gap-x-6 p-4 shrink-0 z-30 relative">
      ...
      <main className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-1/3 md:min-w-[320px] md:shrink-0 bg-slate-900/50 p-6 flex flex-col gap-6 border-b md:border-b-0 md:border-r border-slate-800 md:overflow-y-auto custom-scrollbar">
            <div className="mb-2">
        ...
        <div className="flex-1 bg-slate-950 p-6 flex flex-col gap-6 overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-80 bg-slate-900 border-t md:border-t-0 md:border-l border-slate-800 flex flex-col shrink-0">
